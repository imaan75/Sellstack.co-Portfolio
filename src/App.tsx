...
const PROJECTS = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1555066931-4365d14bab8c?auto=format&fit=crop&q=80&w=1170",
  },
  {
    title: "Loom Web App",
...
const TRUST_LOGOS = [
  ...
  { name: "Raycast", icon: <motion.div className="w-6 h-6 border-2 border-current rounded-lg flex items-center justify-center"><div className="w-2 h-2 bg-current rotate-45"/></motion.div> },
...
export default function App() {
  return (
    <div className="min-h-screen bg-bg-dark selection:bg-primary/30 selection:text-white">
      {/* Container to keep layout consistent and add slight padding on extreme widths */}
          ...
          <div className="relative px-6 pb-12 pt-10 md:px-20 md:pb-24 flex flex-col md:flex-row items-center justify-between z-10 min-h-[500px]">
            ...
            <div className="w-full md:w-1/2 relative mt-12 md:mt-0 flex justify-center md:justify-end">
              ...
              >
                ...
                <img 
                  src="https://images.unsplash.com/photo-1517486808906-6ca8b3f04846?auto=format&fit=crop&q=80&w=1528" 
                  alt="Aesthetic walking shot"
        ...
        <section id="projects" className="py-24 md:py-40 px-6 md:px-20 scroll-mt-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {PROJECTS.map((project, idx) => (
              ...
              >
                <div className="relative aspect-[4/5] overflow-hidden rounded-[30px] bg-bg-inner border border-white/5 mb-6">
                  <img 
                    src={project.image} 
                    alt={project.title}
